...
namespace ogame {
  namespace gui {
    ...
    ActionProviderLabelStateContainer::ActionProviderLabelStateContainer(const std::string& name,
    ...
    ActionProviderLabelStateContainer::~ActionProviderLabelStateContainer() {
      clearText();
    }

    SDL_Surface* ActionProviderLabelStateContainer::createContentPrivate() {
      ...
      ActionProviderStateContainer::clearContentPrivate(croppedArea);
